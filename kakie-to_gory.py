...
def rotate_vector_list(vector_list, x_0, y_0, angle_rad): # rotate around x_0, y_0
    ...
    rotated_list = list((p[0] * math.cos(a) - p[1] * math.sin(a), p[0] * math.sin(a) + p[1] * math.cos(a)) for p in shifted_list)
...
back_mountain = [(1000, 160), (10, 225), (20, 185), (xf1[0], yf1[0]), (xf1[1], yf1[1]), (xf1[2], yf1[2]), (xf1[3], yf1[4]),
         (xf1[5], yf1[5]), (xf1[6], yf1[6]), (xf1[7], yf1[7]), (xf1[8], yf1[8]), (xf1[9], yf1[9]), (xf1[10], yf1[10]),
         (xf1[11], yf1[11]), (xf1[12], yf1[12]), (xf1[13], yf1[13]), (xf1[14], yf1[14]), (325, 100), (350, 125),
         (435, 175), (490, 165), (515, 180), (565, 130), (595, 140), (615, 125), (xf2[0], yf2[0]), (xf2[1], yf2[1]),
         (xf2[2], yf2[2]), (xf2[3], yf2[3]), (xf2[4], yf2[4]), (xf2[5], yf2[5]), (xf2[6], yf2[6]), (xf2[7], yf2[7]),
         ...
         (xf2[18], yf2[18]), (xf2[19], yf2[19]), (xf2[20], yf2[20]), (750, 115), (790, 110), (840, 135), (930, 120)]

draw_rotated_vector_list(back_mountain, 500, 100, 0.13)

penColor(153, 0, 0)
brushColor(153, 0, 0)
middle_mountain = [(1000, 300), (0, 350), (0, 245), (5, 245), (25, 265), (xf3[0], yf3[0]), (xf3[1], yf3[1]), (xf3[2], yf3[2]),
         (xf3[3], yf3[3]), (xf3[4], yf3[4]), (xf3[5], yf3[5]), (xf3[6], yf3[6]), (xf3[7], yf3[7]), (xf3[8], yf3[8]),
         (xf3[9], yf3[9]), (xf3[10], yf3[10]), (175, 240), (235, 275), (255, 215), (320, 235), (385, 270), (520, 250),
         (xf4[0], yf4[0]), (xf4[1], yf4[1]), (xf4[2], yf4[2]), (xf4[3], yf4[3]), (xf4[4], yf4[4]), (xf4[5], yf4[5]),
         (xf4[6], yf4[6]), (xf4[7], yf4[7]), (xf4[8], yf4[8]), (xf4[9], yf4[9]), (xf4[10], yf4[10]), (xf4[11], yf4[11]),
